...
extern "C" void create_world(hitable **list, hitable **wordl);
...
void generateCUDAImage() {
	...
	create_image(blocks, threads, fb, WIDTH, HEIGHT, vec3(-2.0, -1.0, -1.0), vec3(4.0, 0.0, 0.0), vec3(0.0, 2.0, 0.0), vec3(0.0, 0.0, 0.0), d_world);
